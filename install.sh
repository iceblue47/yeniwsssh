...
CDNF="https://raw.githubusercontent.com/iceblue47/yeniwsssh/main/"
###
BURIQ () {
...
echo ""
wget -q https://raw.githubusercontent.com/iceblue47/yeniwsssh/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/iceblue47/yeniwsssh/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
...
clear
wget https://raw.githubusercontent.com/iceblue47/yeniwsssh/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget https://raw.githubusercontent.com/iceblue47/yeniwsssh/main/update/update.sh && chmod +x update.sh && ./update.sh
rm -f update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
